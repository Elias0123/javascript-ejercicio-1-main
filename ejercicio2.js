...
const resultado = familia.some((familia)=>{
    return familia.edad < 18 ;
...
if (resultado === true){
  ...
  const resultado2 = familia.filter((persona)=>{
  ...
  console.log("Esta familia no cuenta con ningun miembro menor a 18 años");
